...
export default function Home(){
 ...
 return <main className="shell"><header className="topbar"><div className="top-actions"><Link href="/account" className="account-pill" title="Account settings">{avatarUrl?<img src={avatarUrl} alt="Account"/>:<span>{(session.user.email||'?').charAt(0).toUpperCase()}</span>}</Link></div></header>
